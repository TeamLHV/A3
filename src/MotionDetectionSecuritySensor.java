...
class MotionDetectionSecuritySensor
{
	public static void main(String args[])
	{
		...
		if (em != null)
		{
			...
			MessageWindow mw = new MessageWindow("Motion Detection Security Sensor", WinPosX, WinPosY );
			...
			mw.WriteMessage("\nInitializing Motion Detection Security Simulation::" );
